...
import gas_why1 from "../assets/allImages/disease/gas/why/overworked-exhausted-tired-businessman-feel-pain-headache-migraine 1 (1).webp";
...
import beauty_why8 from "../assets/allImages/female/beauty/why/overworked-exhausted-tired-businessman-feel-pain-headache-migraine 1 (3).webp";
  //postpartum
  // Benefit images
...
import postpartum_why8 from "../assets/allImages/female/postpartum/why/overworked-exhausted-tired-businessman-feel-pain-headache-migraine 1 (7).webp";
     ...
     programs: [
       {
         ...
         premiumPlans: [
           ...
           { plan: "6 Month", price: "$250" },
           { plan: "12 Months", price: "$480" },
         ],
         testimonials: [
           {
             message:
         ...
         joiners: [
           {
             ...
             problem: [
               ...
               },
               {
                 ...
                 moredetails: "Gas, Acidity, NERD and Reflux",
               },
               {
                 url: gas_why1,
       ...
       },
       {
         ...
         benefits: [
           ...
           {
             benefit: "Neti Kriya: Jal Neti, Dugdh Neti, Rubber Neti, Sutra Neti for nasal cavity cleansing and solutions.",
           ...
           {
             benefit: "Pranayama: Bhramari for sinusitis, snoring, and tinnitus relief.",
             urlImage: ent_benefit1,
           },
           {
             benefit: "Mental Wellness: Healing, meditation, and counseling for emotional and mental strength.",
     ...
     programs: [
       {
         ...
         benefits: [
           ...
           {
             benefit: "Therapeutic Yoga: Helps with PCOD,INFERTILITY PCOS, and Hormonal Health.",
           ...
           {
             benefit: "Balanced Diet & Longevity: Achieve a healthy weight and glowing vitality.",
             urlImage: wellness_benefit5,
           },
           {
             benefit: "Weight Loss -  Achieve Your Weight Loss Goals with the Power of  Yoga,Pilates etc ",
           ...
           {
             benefit: "Healing/Dhyan : Reiki, Pranic, and Chakra Healing for Stress Relief and Emotional Balance .",
         ...
         joiners: [
           {
             ...
             problem: [
               ...
               },
               {
                 ...
                 moredetails:"Helpful in Fertility, boosts Egg production & promotes natural conception",
               },
               {
                 url: wellness_why3,
               ...
               },
               {
                 ...
                 moredetails:"Permanently remove anxiety depression & intrusive thoughts through powerful practice of Dhyan Sadhna and Healing Sessions .",
               },
             ],
           },
         ],
         premiumPlans: [
           ...
           { plan: "6 Month", price: "$150" },
           { plan: "12 Months", price: "$300" },
         ],
         testimonials: [
           {
             message:
             ...
             problem: [
               {
                 ...
                 moredetails:"Embrace motherhood while overcoming postpartum challenges with ease."
               },
               {
                 url: postpartum_why2,
                 shortDescription: "Shape and Glow",
                  moredetails:"Regain your figure, achieve weight loss, and bring back your radiant glow."
               },
               {
                 url: postpartum_why3,
                 shortDescription: "Energize your body",
                 moredetails:"Say goodbye to fatigue and feel rejuvenated every day."
               },
               {
                 url: postpartum_why4,
                 shortDescription: "Pain Relief",
                 moredetails:"Manage back pain, joint pain, and physical discomfort effectively."
               },
               {
                 url: postpartum_why5,
                 shortDescription: "Breastfeed Support",
                 moredetails:"Resolve challenges and nourish your little one with confidence."
               },
               {
                url: postpartum_why6,
                shortDescription: "Emotional Healing",
                moredetails:"Heal anxiety, postpartum depression, and restore mental peace."
              },
              {
                url: postpartum_why7,
                shortDescription: "Control Hair Loss",
                moredetails:"Strengthen your hair and prevent postpartum hair fall"
              },
             ],
           },
         ],
     ...
     programs: [
       {
         ...
         premiumPlans: [
           ...
           { plan: "6 Month", price: "$200" },
           { plan: "12 Months", price: "$380" },
         ],
         testimonials: [
           {
             message:
