...
const Hero = () => {
  ...
  return (
    <>
      <div className={`relative max-w-[1920px] flex justify-around flex-col-reverse sm:flex-row py-4 mb-8 gap-16 sm:gap-8 w-full px-2 md:px-8 pt-16 sm:pt-32 ${open ? "blur-sm" : ""}`}>
        <section className="justify-center px-8 md:w-1/2 -ml-8">
          ...
          <div className=" ml-0 sm:ml-24 lg:ml-48">
            <ArrowLine className=" w-[300px] md:w-[500px] ml-24" />
          </div>
