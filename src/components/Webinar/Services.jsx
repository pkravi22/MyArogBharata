...
const Services = () => {
  return (
    <div class="grid grid-cols-2 text-white justify-center md:grid-cols-4  font-sans  px-2 sm:px-8 pt-8 pb-4 ">
      <div class="flex gap-2   items-center p-4 ">
        <div class="text-4xl  bg-white p-2 rounded-sm">
      ...
      <div class="flex gap-2   items-center p-4 ">
        <div class="text-4xl mb-  bg-white p-2 rounded-sm">
      ...
      <div class="flex gap-2  items-center p-4 ">
        <div class="text-4xl mb-2  bg-white p-2 rounded-sm">
      ...
      <div class="flex gap-2   items-center p-2 ">
        <div class="text-xl mb-2  bg-white p-2 rounded-sm">
