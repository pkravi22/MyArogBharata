...
const HeroWebinar = () => {
  return (
    <div className=" bg-blue-50  px-0 sm:px-8 py-4">
      <div className="flex pt-8 sm:mt-10   bg-white  flex-col gap-[4px] ">
        <div className="flex flex-col gap-[4px] px-2 text-center ">
        ...
        <div className="flex  flex-col sm:flex-row pt-4   gap-8 sm:gap-24">
          ...
          <div className=" w-full sm:w-2/3 flex flex-col pt-8  px-2">
            <div className="grid grid-cols-1 gap-4 text-[18px] xl:text-[24px]">
